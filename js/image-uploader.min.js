    ...
    e.fn.imageUploader = function(t) {
        ...
        let o = function() {
                ...
                if (a.settings.maxFiles > 1) {
                    t = e("<div>", {
                        class: "image-uploader mutiple-images"
                    });
                    n = e("<input>", {
                        type: "file",
                    ...
                    t = e("<div>", {
                        class: "image-uploader single-image"
                    });
                    n = e("<input>", {
                        type: "file",
                        id: a.settings.imagesInputName + "-" + h(),
            ...
            l = function(t, i, o) {
                ...
                return l.on("click", function(e) {
                    ...
                    l.remove(), o.children().hasClass("uploaded-image") || o.parent().removeClass("has-files")
                }), l
            },
            r = function(t) {
            ...
            m = function(e, t) {
                return !(e + s.items.length + a.settings.preloaded.length >= a.settings.maxFiles) || (alert(`Không thể thêm nhiều hơn ${a.settings.maxFiles} ảnh`), !1)
            },
            u = function(t, n) {
                t.addClass("has-files");
                let i = t.find(".uploaded .upload-more"),
                    a = t.find('input[type="file"]');
                e(n).each(function(e, t) {
                    s.items.add(t), i.before(l(URL.createObjectURL(t), s.items.length - 1), !1)
